...
# 乱数でセキュリティ
SECRET_KEY = 'y&l*b4+gzqb%ko30&meucrce_xm0yak6#-g)6=+wc8r(bpj^ui'
...
# 機能のリスト
INSTALLED_APPS = [
    'django.contrib.admin',  # default: admin画面
    'django.contrib.auth',  # default: 権限
